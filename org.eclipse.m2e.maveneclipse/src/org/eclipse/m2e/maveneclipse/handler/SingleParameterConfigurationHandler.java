...
/**
 * Convenient base class for {@link ConfigurationHandler}s that are based around a single
...
public abstract class SingleParameterConfigurationHandler implements ConfigurationHandler {
	...
	public final void handle(MavenEclipseContext context) throws Exception {
		ConfigurationParameter parameter = context.getPluginConfiguration().getParamter(
				getParamterName());
	...
	/**
	 * Handle the {@link MavenEclipseConfiguration} applying the specified
	 * {@link ConfigurationParameter configuration} to the eclipse project.
	 * @param context the {@link MavenEclipseContext}
	 * @param parameter the {@link ConfigurationParameter}
	 * @throws Exception
	 */
	protected abstract void handle(MavenEclipseContext context,
			ConfigurationParameter parameter) throws Exception;
